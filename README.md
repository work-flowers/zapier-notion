...
Polls the most recently created pages (up to 20) in the data source and scans their child blocks for matches. Returns a `block_url` field with the full Notion URL (page + block fragment) for use with Notion MCP.
